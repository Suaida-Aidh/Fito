...
import { addTrainer } from '../../redux/slices/trainerSlice'; // Update path as needed
...
const AddTrainer = () => {
    ...
    const handleRegister = async (e) => {
        ...
        const result = await dispatch(addTrainer({ username, email, password }));
        
        if (addTrainer.fulfilled.match(result)) {
            console.log('Trainer added Successful');
            setEmailSent(true);
            navigate('/trainerMgmt') 
        } else {
